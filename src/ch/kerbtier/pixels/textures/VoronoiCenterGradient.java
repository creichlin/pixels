...
public class VoronoiCenterGradient implements MonoProducer {
  @Param(0)
  ...
  public VoronoiCenterGradient() {
    
  }
  
  public VoronoiCenterGradient(MonoProducer dx, MonoProducer dy) {
    this.dx = dx;
    this.dy = dy;
  }
  ...
  public float get(float x, float y) {
    ...
    float dc = here.distance(closest);
    float db = here.distance(brother);
