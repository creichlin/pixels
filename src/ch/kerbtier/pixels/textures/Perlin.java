...
public class Perlin implements MonoProducer {
  ...
  // values from mr perlin
  static final int p[] = new int[512], permutation[] = { 151, 160, 137, 91, 90,
  ...
  static public float jnoise(double x, double y) {
    int X = (int) Math.floor(x) & 255;
    int Y = (int) Math.floor(y) & 255;
    return (float) ((p[p[X] + Y]) / 256f);
  }
